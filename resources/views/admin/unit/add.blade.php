    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box">
                ...
                <h4 class="page-title">Unit Add </h4>
            </div>
        </div>
    </div>
    <div class="row">
                        ...
                        <div class="tab-pane show active" id="basic-form-preview">
                            <form action="{{route('unit.new')}}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-10">
                                        <input type="text" class="form-control @error('name') is-invalid @enderror" name="name" id="inputEmail3" placeholder="Unit Name"/>
                                        @error('name')
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-10">
                                        <input type="text" class="form-control @error('description') is-invalid @enderror" name="description" id="inputEmail3" placeholder="Unit Description"/>
                                        @error('description')
                                        <div class="alert alert-danger">{{ $message }}</div>
                                        @enderror
                                    </div>
