                        ...
                        <div class="tab-pane show active" id="basic-form-preview">
                            <form action="{{route('size.new')}}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-md-10">
                                        <input type="text" class="form-control @error('description') is-invalid @enderror" name="description" id="inputEmail3" placeholder="Size Description"/>
                                        @error('description')
                                        <div class="alert alert-danger">{{ $message }}</div>
                                        @enderror
                                    </div>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-md-10">
                                        ...
                                        <input type="checkbox" id="switch1" checked value="1" name="status" class="form-control" data-switch="bool"/>
